...
Los tests históricos de investigación comparaban archivos completos contra el estado anterior a los escaneos. Se registran las modificaciones posteriores con sus hashes, seis IDs de catálogo y cinco índices de compañías. Las comprobaciones de preservación histórica de PS1 y la verificación y reproducción de PS2 comprueban ese registro y utilizan sus entradas históricas exactas, restaurando siempre los archivos actuales. Las pruebas funcionales de PS1 siguen ejecutándose sobre el catálogo y los módulos actuales. No se omiten comprobaciones ni se aceptan cambios fuera del registro.
