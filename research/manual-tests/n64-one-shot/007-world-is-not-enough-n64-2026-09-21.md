# Prueba única N64 — orden completa sin correcciones posteriores

Esta prueba evalúa si una sola orden completa produce un resultado válido. No esperes mensajes de ampliación ni correcciones durante la investigación.

- **researchId asignado:** `007-world-is-not-enough-n64-2026-09-21`
- **archivo de salida obligatorio:** `007-world-is-not-enough-n64-2026-09-21.json`
- **modo:** investigación única, sin modificar GitHub, RegionAtlas, catálogo, cola, arquitectura ni reglas.
- **entrega:** adjunta el archivo JSON real en esta misma conversación. No pegues el JSON como texto.
- **alcance:** termina este juego antes de responder. Si un campo no puede confirmarse, devuélvelo como `unresolved`; no pidas instrucciones adicionales ni rebajes los requisitos.
- **precios:** usa exclusivamente anuncios activos e independientes de segunda mano conforme a la orden. Ventas completadas, anuncios vendidos o inactivos no cuentan para `sampleSize`.
- **telemetría:** incluye `queryLedger` y `sourceAttempts` completos; no califiques fuentes como recomendadas.

El `researchId` anterior es el valor obligatorio para el campo raíz `researchId` y para el nombre del archivo.
...
```json
{
  "canonicalId": "catalog:n64-007-world-is-not-enough",
  "canonicalTitle": "007  World is Not Enough",
  "sortTitle": "007  World is Not Enough",
  "franchise": null,
  "series": null,
  "releaseYear": 2000,
  "platforms": [
  ...
  "identityBasis": "catalog-entry",
  "catalogIds": [
    "n64-007-world-is-not-enough"
  ],
  "sourceTitles": [
    "007  World is Not Enough"
  ],
  "possibleDuplicateGroups": [
    "title:007 world is not enough"
  ]
}
```
...
```json
{
  "platformWorker": "n64-one-shot-test",
  "catalogEntries": [
    {
      "id": "n64-007-world-is-not-enough",
      "slug": "007-world-is-not-enough",
      "title": "007  World is Not Enough",
      "titlePc": "007  World is Not Enough",
      "platformSlug": "n64",
      "region": "PAL Europa",
      "edition": "standard",
      "listingStatus": "listed",
      "coverUrl": "/covers/n64/007-world-is-not-enough.jpg",
      "pcPath": "/game/pal-nintendo-64/007-world-is-not-enough",
      "pcId": 39992,
      "pcRegion": "PAL",
      "pcCondition": null,
      ...
      "marketMin": 75.18,
      "marketMax": 75.18,
      "recommendedPrice": 75.18,
      "pcRefPrice": null,
      "deltaEsVsPc": null,
      "priceSource": "eBay ES",
      "updatedAt": "2026-09-06T20:30:30Z",
      "hasEsPrice": true,
      "seedSource": "pricecharting-pal",
      "museumPath": "/juegos/nintendo-64/pal/007-world-not-enough",
      "museumSlug": "007-world-not-enough",
      "museumRegion": "pal",
      "regionEvidence": [
        "PriceCharting PAL Nintendo 64; país concreto por verificar"
      ],
      "priceRegionVerified": false,
      "estimatedPriceComplete": 75.18,
      "priceDataSources": "eBay ES",
      "estimatedShippingToSpainComplete": 18.16,
      "estimatedTotalToSpainComplete": 93.34
    }
  ],
  "gameDetailsByCatalogId": {
    "n64-007-world-is-not-enough": {
      "year": 2000,
      "releaseDate": "December 8, 2000",
      "reference": "NUS-N07P",
      "players": 4,
      "support": "Cartucho",
      "developer": {
      ...
      "sources": {
        "museum": {
          "museumPath": "/juegos/nintendo-64/pal/007-world-not-enough",
          "fetchedAt": "2026-06-12T20:32:05"
        },
        "pricecharting": {
          "pcPath": "/game/pal-nintendo-64/007-world-is-not-enough",
          "fetchedAt": "2026-06-13T12:56:43",
          "productId": 39992
        }
      },
      "fieldSources": {
      ...
      "fetchedAt": "2026-06-15T07:14:28",
      "mergedAt": "2026-06-15T07:14:28",
      "pegi": "Not Applicable"
    }
  }
}
