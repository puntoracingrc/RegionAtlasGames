...
```json
{
  "canonicalId": "catalog:ps1-usa-2-game-value-pack-target-exclusive",
  "canonicalTitle": "2 Game Value Pack [Target Exclusive]",
  "sortTitle": "2 Game Value Pack [Target Exclusive]",
  "franchise": null,
  "series": null,
  "releaseYear": null,
  "platforms": [
  ...
  "knownRegions": [
    "NTSC-U/C · Mercado por determinar"
  ],
  "knownEditionTypes": [
    "STANDARD"
  ],
  ...
  "catalogIds": [
    "ps1-usa-2-game-value-pack-target-exclusive"
  ],
  "sourceTitles": [
    "2 Game Value Pack [Target Exclusive]"
  ],
...
```json
{
  ...
  "catalogEntries": [
    {
      "id": "ps1-usa-2-game-value-pack-target-exclusive",
      "slug": "2-game-value-pack-target-exclusive",
      "title": "2 Game Value Pack [Target Exclusive]",
      "titlePc": "2 Game Value Pack [Target Exclusive]",
      "platformSlug": "ps1",
      "region": "NTSC-U/C · Mercado por determinar",
      ...
      "priceChartingCurrency": null,
      "priceChartingUsdPerEur": null,
      "priceChartingExchangeRateDate": null,
      "priceChartingCollectedAt": null,
      "canonicalSeoSlug": "2-game-value-pack-target-exclusive-ps1-pal-us",
      "regionFamily": "NTSC-U/C",
      "marketRegion": null,
      "regionCode": null,
      "regionalStatus": "review",
      "workId": null,
      "languages": [],
      "canonicalSerials": [],
      "sourceSerials": [],
  ...
  "publicCatalogUrl": "https://www.regionatlas.games/catalogo/2-game-value-pack-target-exclusive-ps1-pal-us",
  "publicCatalogStatus": "EDICION_PENDIENTE_DE_IDENTIFICAR"
}
```
...
Fecha de investigación: `2026-09-23`.
