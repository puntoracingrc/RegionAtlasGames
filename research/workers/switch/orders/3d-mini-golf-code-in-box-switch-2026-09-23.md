...
```json
{
  "canonicalId": "catalog:switch-3d-mini-golf-code-in-box",
  "canonicalTitle": "3D Mini Golf [Code In Box]",
  "sortTitle": "3D Mini Golf [Code In Box]",
  "franchise": null,
  "series": null,
  "releaseYear": null,
  "platforms": [
  ...
  "catalogIds": [
    "switch-3d-mini-golf-code-in-box"
  ],
  "sourceTitles": [
    "3D Mini Golf [Code In Box]"
  ],
  ...
  "catalogEntries": [
    {
      ...
      "coverUrl": "/covers/switch/3d-mini-golf.jpg",
      "pcId": 67478,
    ...
    {
      "id": "switch-3d-mini-golf-code-in-box",
      "slug": "3d-mini-golf-code-in-box",
      "title": "3D Mini Golf [Code In Box]",
      "platformSlug": "switch",
      "region": "PAL España",
      "edition": "standard",
      "physicalVariant": null,
      "coverUrl": "/covers/switch/3d-mini-golf-code-in-box.jpg",
      "pcId": 7308805,
      "pcRegion": "PAL EU (referencia)",
      "matchConfidence": "SEED_PC",
      "regionEvidence": [
