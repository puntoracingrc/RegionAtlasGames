...
```json
{
  "canonicalId": "catalog:switch-drive-rally-special-edition",
  "canonicalTitle": "#Drive Rally [Special Edition]",
  "sortTitle": "#Drive Rally [Special Edition]",
  "franchise": null,
  "series": null,
  "releaseYear": null,
  "platforms": [
  ...
  "catalogIds": [
    "switch-drive-rally-special-edition"
  ],
  "sourceTitles": [
    "#Drive Rally [Special Edition]"
  ],
  "possibleDuplicateGroups": [
    "title:drive rally special edition"
  ]
}
```
...
```json
{
  "catalogEntries": [
    {
      "id": "switch-drive-rally-special-edition",
      "slug": "drive-rally-special-edition",
      "title": "#Drive Rally [Special Edition]",
      "titlePc": "#Drive Rally [Special Edition]",
      "platformSlug": "switch",
      "region": "PAL España",
      "physicalVariant": null,
      "edition": "standard",
      "listingStatus": "listed",
      "coverUrl": "/covers/switch/drive-rally-special-edition.jpg",
      "pcPath": "/game/pal-nintendo-switch/drive-rally-special-edition",
      "pcId": 13574639,
