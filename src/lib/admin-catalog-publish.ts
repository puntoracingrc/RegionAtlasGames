...
export function mergeCatalogFromDraft(existing: CatalogGame, draft: AdminGameDraft): CatalogGame {
  ...
  const entry: CatalogGame = {
    ...
    platformSlug: draft.platformSlug,
    region: draft.region,
    workId: draft.workId ?? existing.workId ?? null,
    regionalStatus: draft.regionalStatus ?? existing.regionalStatus,
...
export async function clonePublishedCatalogGameToRegion(input: {
  ...
  const entry: CatalogGame = {
    ...
    estimatedShippingToSpainLoose: null,
    estimatedShippingToSpainGameManual: null,
    estimatedShippingToSpainComplete: null,
    estimatedShippingToSpainSealed: null,
    estimatedTotalToSpainLoose: null,
    estimatedTotalToSpainGameManual: null,
    estimatedTotalToSpainComplete: null,
    estimatedTotalToSpainSealed: null,
