...
> = {
  ...
  psp: { shortName: "PSP", manufacturer: "sony", sortOrder: 30 },
  psvita: { shortName: "PS Vita", manufacturer: "sony", sortOrder: 31 },
  wiiu: { shortName: "Wii U", manufacturer: "nintendo", sortOrder: 32 },
  pcengine: { shortName: "PC Engine", manufacturer: "other", sortOrder: 33 },
