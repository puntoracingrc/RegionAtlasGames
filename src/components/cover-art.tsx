  ...
  return (
    <div
      className={cn(
        ...
        isDetail
          ? "rounded-xl border-border/80 bg-gradient-to-b from-black/10 to-black/25 shadow-xl shadow-black/50 ring-1 ring-white/10"
          : "rounded-lg border-border shadow-md shadow-black/30",
        isDetail
          ? cn(coverDetailSizeClass(platformSlug), className)
          : cn(coverCardAspectClass(), "w-full", className),
      )}
    >
      {showImage ? (
        isDetail ? (
